...
import { PDFFullscreenDialog } from './_components/pdf-fullscreen-dialog';


const PDFRendererPage = ({ params }: { params: { fileId: Id<"_storage"> } }) => {
        ...
        <div className="w-full rounded-md shadow-md flex flex-col items-center">
            <div className="h-14 w-full border-b border-zinc-200 flex items-center justify-between">
                ...
                <div className="space-x-2">
                    ...
                    <PDFFullscreenDialog fileId={params.fileId} />
                </div>
            </div>
