...
export const Sidebar = () => {
    ...
    return (
        <div className="w-56 flex flex-col justify-start space-y-4">
            ...
            <Link href="/dashboard/trash" className={cn(`flex items-center gap-x-2 font-medium hover:underline decoration-highlight-color transform hover:-translate-y-1 transition-all duration-400`, pathname.includes("/dashboard/favorites") && "text-primary-color underline decoration-highlight-color decoration-4")}>
